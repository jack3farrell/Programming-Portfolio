...
public class MergeSorterTest {
	...
	public void testSortStudentName() {
		Sorter<Student> studentNameSorter = new MergeSorter<Student>(null);
		// Ascending
	...
	public void testSortStudentGPA() {
		Sorter<Student> studentGPASorter = new MergeSorter<Student>(new StudentGPAComparator());
	...
	public void testSortStudentID() {
		Sorter<Student> studentIDSorter = new MergeSorter<Student>(new StudentIDComparator());
