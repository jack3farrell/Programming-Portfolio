 ...
 * data type behaviors when using a sorted linked list data structure that uses
 * binary search like algorithm to locate entries based on the key of the entry
 *
 * @author Dr. King
 * @author Jack Farrell
 *
