...
//	private String[] dataStringRandom = { "bac", "dad", "abc", "eve", "cab" };
	...
	public void testSortStudentName() {
		Sorter<Student> studentNameSorter = new SelectionSorter<Student>();
	...
	public void testSortStudentGPA() {
		Sorter<Student> studentGPASorter = new SelectionSorter<Student>(new StudentGPAComparator());
	...
	public void testSortStudentID() {
		Sorter<Student> studentIDSorter = new SelectionSorter<Student>(new StudentIDComparator());
