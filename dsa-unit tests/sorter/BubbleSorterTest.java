...
/**
 * Bubble sorter algorithms tests
 * 
 * @author Jack Farrell
 */
...
//	private String[] dataStringRandom = { "bac", "dad", "abc", "eve", "cab" };
	...
	public void testSortStudentName() {
		Sorter<Student> studentNameSorter = new BubbleSorter<Student>(null);
	...
	public void testSortStudentGPA() {
		Sorter<Student> studentGPASorter = new BubbleSorter<Student>(new StudentGPAComparator());
	...
	public void testSortStudentID() {
		Sorter<Student> studentIDSorter = new BubbleSorter<Student>(new StudentIDComparator());
